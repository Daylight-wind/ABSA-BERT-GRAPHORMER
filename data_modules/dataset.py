...
class ClassificationDataset(Dataset):   # 继承了Dateset
    def __init__(self, config, vocab, stage='TRAIN', on_memory=True, corpus_lines=None, mode="TRAIN",bert_tokenizer=None):
        ...
        self.sample_position = get_sample_position(self.corpus_file, self.on_memory, corpus_lines, stage)   # 每一行开始的索引，可以代表每一行的长度
